...
{
    /// <summary>
    /// Parse File Manager is responsible for parsing pdc files and writing them to rt_upgrade_command.
    /// </summary>
    public class ParseFileManager
    {
        ...
        public void ReadFilesToInsert(string scriptType)
        {
            ...
            foreach (string lynxFolder in lynxFoldersAll)
            {
                ...
                {
                    // If 900 Folder then write to finalize //
                    insertV.finalIndication = "'N'";
        ...
        public void ParseForDbInsert(ref OracleAccessor oc, string filePath, int sectionNum)
        {
            bool inBlock = false;
            string readLine = "";
        ...
        public void InsertIntoDatabase(ref string insertTextHold, ref OracleAccessor oc, int sectionNum)
        {
            // Local Variables //
            string preview = "";
            ...
            if (insertText.Length >= 4000)
            {
                ...
                // Break it down more if over Max //
        ...
        public void WriteRunUpgrade(string lynxFolder)
        {
            ...
            {
                Console.WriteLine(e.Message);
                Console.WriteLine("Write to run_upgrade Failed!");
            }
        }
        ...
        public void WriteRunFinalize(string folder, int numOfSchemas)
        {
            ...
            {
                Console.WriteLine(e.Message);
                Console.WriteLine("Write to run_finalized Failed!");
            }
        }
